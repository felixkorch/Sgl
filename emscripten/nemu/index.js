...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 5327360,
    DYNAMIC_BASE = 5327360,
    DYNAMICTOP_PTR = 84224;
...
// {{PRE_LIBRARY}}
  ...
  var _stderr=84272;var FS={root:null,mounts:[],devices:{},streams:[],nextInode:1,nameTable:null,currentPath:"/",initialized:false,ignorePermissions:true,trackingDelegate:{},tracking:{openFlags:{READ:1,WRITE:2}},ErrnoError:null,genericErrors:{},filesystems:null,syncFSRequests:0,handleFSError:function (e) {
  ...
  var ___tm_timezone=(stringToUTF8("GMT", 84368, 4), 84368);function _gmtime_r(time, tmPtr) {
