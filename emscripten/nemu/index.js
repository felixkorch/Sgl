...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 5287200,
    DYNAMIC_BASE = 5287200,
    DYNAMICTOP_PTR = 44064;
...
// {{PRE_LIBRARY}}
  ...
  var _stderr=44112;var FS={root:null,mounts:[],devices:{},streams:[],nextInode:1,nameTable:null,currentPath:"/",initialized:false,ignorePermissions:true,trackingDelegate:{},tracking:{openFlags:{READ:1,WRITE:2}},ErrnoError:null,genericErrors:{},filesystems:null,syncFSRequests:0,handleFSError:function (e) {
  ...
  var ___tm_timezone=(stringToUTF8("GMT", 44208, 4), 44208);function _gmtime_r(time, tmPtr) {
