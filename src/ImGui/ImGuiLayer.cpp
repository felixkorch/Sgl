...
#include "Sgl/ImGui/ImGuiRenderer.h"
...
void ImGuiLayer::OnEvent(Event& event)
{
    ...
    dispatcher.Dispatch<MouseButtonPressed>(SGL_BIND(ImGuiLayer::OnMouseButtonPressedEvent));
    dispatcher.Dispatch<MouseButtonReleased>(SGL_BIND(ImGuiLayer::OnMouseButtonReleasedEvent));
    dispatcher.Dispatch<MouseMovedEvent>(SGL_BIND(ImGuiLayer::OnMouseMovedEvent));
    dispatcher.Dispatch<MouseScrolledEvent>(SGL_BIND(ImGuiLayer::OnMouseScrolledEvent));
    dispatcher.Dispatch<KeyPressedEvent>(SGL_BIND(ImGuiLayer::OnKeyPressedEvent));
    dispatcher.Dispatch<KeyTypedEvent>(SGL_BIND(ImGuiLayer::OnKeyTypedEvent));
    dispatcher.Dispatch<KeyReleasedEvent>(SGL_BIND(ImGuiLayer::OnKeyReleasedEvent));
    dispatcher.Dispatch<WindowResizedEvent>(SGL_BIND(ImGuiLayer::OnWindowResizeEvent));
}
